            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {(userRole === Role.SYSTEM_ADMIN ||
                ...
                <li>
                  ...
                  >
                    <span className="icon-[hugeicons--calendar-01] text-xl"></span>
                    Eventos
                  </Link>
                </li>
              )}
              ...
              {(userRole === Role.SYSTEM_ADMIN ||
                ...
                <SidebarLinkGroup
                  activeCondition={
                    ...
                    pathname.includes("dashboard/tickets")
                  }
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        ...
                        >
                          <span className="icon-[hugeicons--ticket-01] text-xl"></span>
                          Tickets
                          <svg
                            className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                              open && "rotate-180"
                          ...
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <li>
                              <Link
                                ...
                                className={
                                  "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                  (pathname === "/dashboard/tickets/generate" &&
                                    "!text-white")
                                }
                              >
                                Generar QR&apos;s
                            ...
                            {/* <li>
                              <Link
                                href="/dashboard/tickets/generate-massive"
                                className={
                                  "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                  (pathname === "/dashboard/tickets/resume" &&
                                    "!text-white")
                                }
                              >
                                Envio Masivo
              ...
              )}
              {
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("/dashboard/scanner") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <span className="icon-[hugeicons--camera-01] text-xl"></span>
                  Escáner
                </Link>
              }
              ...
              {/* {(userRole === Role.SYSTEM_ADMIN ||
                ...
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/users/list" || pathname.includes("/users/")
                  }
                >
                  {(handleClick, open) => {
                    return (
                          ...
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <li>
                              <Link
                                ...
                                className={
                                  "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                  (pathname === "/users/list" && "!text-white")
                                }
                              >
                                Lista de usuarios
                              </Link>
